...
// Funcao para verificar se dois numeros racionais sao iguais
int equal(RATIONAL r1, RATIONAL r2) {
    // Simplificar os dois numeros racionais
    r1 = simplificaRacional(r1);
    r2 = simplificaRacional(r2);

    // Verificar se o numerador e denominador de ambos sao iguais
